...
export const RegisterForm: React.FC<RegisterFormProps> = ({
  ...
  const handleOAuthRegister = (provider: 'google' | 'github') => {
    // OAuth registration would be handled by NextAuth
    window.location.href = `/api/auth/signin/${provider}?callbackUrl=${encodeURIComponent(redirectTo)}`;
  };
    ...
    <div className="w-full max-w-md mx-auto">
      <div className="bg-white shadow-lg rounded-lg p-8">
        <div className="text-center mb-8">
          ...
          <p className="text-gray-600 mt-2">Join us to start your AI learning journey</p>
        </div>
